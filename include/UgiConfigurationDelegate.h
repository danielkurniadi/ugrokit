 ...
 */
@property (retain, nonatomic) NSArray * _Nullable specificRegionsForGrokkerInitialization;
 ...
 */
- (void) notifyLoadRegionFailureWithCompletion:(nonnull void(^)(void))retryCompletion;
 ...
 */
- (void) chooseRegionFromRegions:(NSArray<NSString *> * _Nonnull)regionNames
               withSelectedIndex:(int)selectedIndex
                  withCompletion:(nonnull void(^)(NSString * _Nonnull regionName))completion;
 ...
 */
- (void) notifySetRegionSuccess:(NSString * _Nonnull)regionName
                 withCompletion:(nonnull void(^)(void))completion;
...
/**
 ...
 @param completion          Block to execute after notification is completed
 */
- (void) notifySetRegionFailure:(NSString * _Nonnull)regionName
                 withCompletion:(nonnull void(^)(void))completion;
