 ...
 */
typedef void (^GetRegionNamesCompletion)(NSArray * _Nullable regionNames,
                                         int selectedIndex,
 ...
 */
- (void) getRegionNames:(nonnull GetRegionNamesCompletion)completion;
 ...
 */
- (void) setRegion:(NSString * _Nonnull)regionName
    withCompletion:(nonnull SetRegionCompletion)completion;
