...
typedef NS_OPTIONS(NSUInteger, UgiGrokkerPasswordReturnValues) {
...
@property (readonly, nonatomic, nullable) NSString *readerHardwareTypeName;
 ...
 */
- (void) getBatteryInfoWithCompletion:(nonnull void(^)(UgiBatteryInfo * _Nonnull info))completion;
